...
class TestSaveTagHelper(TestCase):
    ...
    def setUp(self):
        self.python_tag = Tag(title="Python")
    ...
    def test_mixed_new_and_old_tags(self):
        ...
        try:
            ...
            self.fail("Save_tags did not created tags")
        self.assertEqual(self.q.tags.all().count(), 3)
        self.assertEqual(self.python_tag, Tag.objects.get(title="Python"))
    ...
    def test_seconds(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_minutes=random_seconds):
                seconds_ago = datetime.now(timezone.utc) - timedelta(
    ...
    def test_minutes(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_minutes=random_minutes):
                minutes_ago = datetime.now(timezone.utc) - timedelta(
    ...
    def test_hours(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_hours=random_hours):
                hours_ago = datetime.now(timezone.utc) - timedelta(hours=random_hours)
    ...
    def test_days(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_days=random_days):
                days_ago = datetime.now(timezone.utc) - timedelta(days=random_days)
    ...
    def test_weeks(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_weeks=random_weeks):
                weeks_ago = datetime.now(timezone.utc) - timedelta(weeks=random_weeks)
    ...
    def test_months(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_months=random_months):
                months_ago = datetime.now(timezone.utc) - timedelta(
    ...
    def test_years(self):
        for _ in self.attempts:
            ...
            with self.subTest(random_years=random_years):
                years_ago = datetime.now(timezone.utc) - timedelta(
                    days=random_years * 365
                )
